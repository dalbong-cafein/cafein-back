...
class ReviewServiceImplTest {
    ...
    void 리뷰_수정() throws Exception{
        ...
        //리뷰 이미지 생성
        List<ReviewImage> imageList = createReviewImage(review, imageFiles);
    ...
    private List<ReviewImage> createReviewImage(Review review, List<MultipartFile> imageFiles) throws IOException {
